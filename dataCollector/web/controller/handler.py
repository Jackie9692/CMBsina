...
class RegisterHandler(RHandler):
    ...
    def get(self):
        ...
        self.render("register.html", projectCodeList=projectCodeList, moduleCodeList=moduleCodeList,
                    classDetailCodeList=classDetailCodeList)
...
class RegisterSaveHandler(RHandler):
    def post(self):
        ...
        apiDetailDic = {"projectName": str(projectName), "moduleName": str(moduleName), "className": str(className),
                        "methodName": str(methodName), "restMethodName": str(restMethodName),
                        "requestWay": str(requestWay),
                        "paraDescription": str(paraDescription), "invokeExample": str(invokeExample),
                        "returnSegment": str(returnSegment),
                        "returnDescription": str(returnDescription), "workStatus": str(workStatus),
                        "retrunFormat": str(retrunFormat),
...
class APIEdit(RHandler):
    ...
    def post(self):
        ...
        apiDetailDic = {"projectName": projectName, "moduleName": moduleName, "className": className,
                        "methodName": methodName, "restMethodName": restMethodName, "requestWay": requestWay,
                        "paraDescription": paraDescription, "invokeExample": invokeExample,
