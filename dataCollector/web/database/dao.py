...
class APIDetailDao():
    # 保存api
    def save(self, dic):
        api_detail = APIDetail(project_code=dic["projectName"], module_code=dic["moduleName"],
                               class_code=dic["className"],
                               method_name=dic["methodName"], rest_method_name=dic["restMethodName"],
                               visit_method_way=dic["requestWay"],
                               paras_detail=dic["paraDescription"], invoke_example=dic["invokeExample"],
                               return_segments=dic["returnSegment"],
